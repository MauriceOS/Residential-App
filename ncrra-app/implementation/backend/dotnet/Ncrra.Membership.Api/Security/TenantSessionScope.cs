// NCRRA membership tenant context: server-derived claim is bound to the same transaction used for RLS-protected data access.
using System.Security.Claims;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Storage;
using Ncrra.Membership.Api.Persistence;

namespace Ncrra.Membership.Api.Security;

public sealed class TenantSessionScope(MembershipDbContext database)
{
